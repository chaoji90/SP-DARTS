...
class Analyzer(object):
    ...
    def __init__(self, conf, args, model,criterion):
        self.network_momentum = conf.momentum
        self.network_weight_decay = conf.decay
    ...
    def _hessian(self, outputs, inputs, out=None, allow_unused=False, create_graph=False):
