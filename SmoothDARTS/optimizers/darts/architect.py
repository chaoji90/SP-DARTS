...
class Architect(object):
    ...
    def _val_loss(self, model, input, target,temp):
        return model._loss(input, target,temp)
    ...
    def step(self, input_train, target_train, input_valid, target_valid, eta, network_optimizer, unrolled,temp=1):
    ...
    def _backward_step(self, input_valid, target_valid,temp):
        loss = self._val_loss(self.model, input_valid, target_valid,temp)
        loss.backward()
